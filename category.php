                                            ...
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image">
                                                            <a href="details.php?id=<?=base64_encode($proByCatResult['id']);?>"><img src="admin/upload/<?=$proByCatResult['thumbnail'];?>" alt=""></a>
                                                        </div>
                                                        <!-- /.image -->
                                                    ...
                                                    <div class="product-info text-left">
                                                        <h3 class="name"><a href="details.php?id=<?=base64_encode($proByCatResult['id']);?>"><?=$proByCatResult['title'];?></a></h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="description"></div>
                                                        <div class="product-price"> <span class="price"> $<?=$proByCatResult['price'];?></span> <span class="price-before-discount">$ 800</span> </div>
                                                        <!-- /.product-price -->
