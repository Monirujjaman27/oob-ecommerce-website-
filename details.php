                                ...
                                <div class="product-info">
                                    ...
                                    <div class="stock-container info-container m-t-10">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="stock-box">
                                                    <span class="value"><?=$result['availability'];?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- /.row -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="price-box">
                                                    ...
                                                    <span class="price-strike">$ <?php $ttl = $result['price']+$result['discount']; echo $ttl?></span>
                                                </div>
                                            </div>

                                            <div class="col-sm-6">
                                                <div class="favorite-button m-t-10">
                                                    <a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Wishlist" href="?addWishlist=<?=base64_encode($result['id']);?>">
                                                        <i class="fa fa-heart"></i>
                                                    </a>
                                                    <a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Add to Compare" href="?compireId=<?=base64_encode($result['id']);?>">
